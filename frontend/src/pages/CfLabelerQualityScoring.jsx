...
/**
 * Gap/CFS Feature Page: Labeler quality scoring
 * Slug: labeler-quality-scoring
 * Backend: /api/cf-labeler-quality-scoring
 */
export default function LabelerQualityScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-labeler-quality-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Labeler quality scoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Track labeler accuracy; route items to higher-quality labelers.</p>
