...
/**
 * Gap/CFS Feature Page: Missing `/auto-label`, `/suggest-labels`, `/detect-disagreement`, `/identify-ambiguous-items`, `/recommend-label-strategy`, `/active-learnin
 * Slug: missing-auto-label-suggest-labels-detect-disagreement-identi
 * Backend: /api/gap-missing-auto-label-suggest-labels-detect-disagreement-identi
 */
export default function MissingAutoLabelSuggestLabelsDetectDisagreementIdentiPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-missing-auto-label-suggest-labels-detect-disagreement-identi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Missing `/auto-label`, `/suggest-labels`, `/detect-disagreement`, `/identify-ambiguous-items`, `/recommend-label-strategy`, `/active-learnin</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Missing `/auto-label`, `/suggest-labels`, `/detect-disagreement`, `/identify-ambiguous-items`, `/recommend-label-strategy`, `/active-learning`.</p>
