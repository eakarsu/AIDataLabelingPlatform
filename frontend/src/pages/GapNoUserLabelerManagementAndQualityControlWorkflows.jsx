...
/**
 * Gap/CFS Feature Page: No user/labeler management and quality-control workflows.
 * Slug: no-user-labeler-management-and-quality-control-workflows
 * Backend: /api/gap-no-user-labeler-management-and-quality-control-workflows
 */
export default function NoUserLabelerManagementAndQualityControlWorkflowsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-user-labeler-management-and-quality-control-workflows', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No user/labeler management and quality-control workflows.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No user/labeler management and quality-control workflows.</p>
