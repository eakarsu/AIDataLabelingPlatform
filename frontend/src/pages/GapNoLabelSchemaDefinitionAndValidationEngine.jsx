...
/**
 * Gap/CFS Feature Page: No label-schema definition and validation engine.
 * Slug: no-label-schema-definition-and-validation-engine
 * Backend: /api/gap-no-label-schema-definition-and-validation-engine
 */
export default function NoLabelSchemaDefinitionAndValidationEnginePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-label-schema-definition-and-validation-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No label-schema definition and validation engine.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No label-schema definition and validation engine.</p>
