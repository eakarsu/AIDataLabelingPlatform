...
/**
 * Gap/CFS Feature Page: Label quality prediction
 * Slug: label-quality-prediction
 * Backend: /api/cf-label-quality-prediction
 */
export default function LabelQualityPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-label-quality-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Label quality prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify likely incorrect labels; flag for human review.</p>
