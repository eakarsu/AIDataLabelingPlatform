...
/**
 * Gap/CFS Feature Page: No dataset management or versioning surface.
 * Slug: no-dataset-management-or-versioning-surface
 * Backend: /api/gap-no-dataset-management-or-versioning-surface
 */
export default function NoDatasetManagementOrVersioningSurfacePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dataset-management-or-versioning-surface', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No dataset management or versioning surface.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No dataset management or versioning surface.</p>
