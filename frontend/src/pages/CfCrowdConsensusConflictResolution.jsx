...
/**
 * Gap/CFS Feature Page: Crowd consensus & conflict resolution
 * Slug: crowd-consensus-conflict-resolution
 * Backend: /api/cf-crowd-consensus-conflict-resolution
 */
export default function CrowdConsensusConflictResolutionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-crowd-consensus-conflict-resolution', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Crowd consensus & conflict resolution</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Aggregate multiple labeler opinions; flag disagreements; auto-suggest resolution.</p>
