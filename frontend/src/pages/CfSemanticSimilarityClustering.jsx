...
/**
 * Gap/CFS Feature Page: Semantic similarity clustering
 * Slug: semantic-similarity-clustering
 * Backend: /api/cf-semantic-similarity-clustering
 */
export default function SemanticSimilarityClusteringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-semantic-similarity-clustering', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Semantic similarity clustering</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Group similar items; suggest labels based on similar items in cluster.</p>
