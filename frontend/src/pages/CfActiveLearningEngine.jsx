...
/**
 * Gap/CFS Feature Page: Active learning engine
 * Slug: active-learning-engine
 * Backend: /api/cf-active-learning-engine
 */
export default function ActiveLearningEnginePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-active-learning-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Active learning engine</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify most valuable unlabeled items to label next; maximize model improvement per label.</p>
