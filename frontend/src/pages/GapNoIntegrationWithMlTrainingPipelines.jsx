...
/**
 * Gap/CFS Feature Page: No integration with ML training pipelines.
 * Slug: no-integration-with-ml-training-pipelines
 * Backend: /api/gap-no-integration-with-ml-training-pipelines
 */
export default function NoIntegrationWithMlTrainingPipelinesPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-integration-with-ml-training-pipelines', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No integration with ML training pipelines.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No integration with ML training pipelines.</p>
